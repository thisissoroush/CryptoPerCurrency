namespace CryptoPerCurrency.Api.Exceptions;

public class CryptoPerCurrencyException : Exception
{
    public CryptoPerCurrencyException(int statusCode, string? message = null, string? technicalMessage = null)
        : base(message)
    {
